...
public class Main {
	...
	final static ConcurrentHashMap<String, Object> properties = new ConcurrentHashMap<String, Object>();
	final static ArrayList<String> tasks = new ArrayList<String>();
	static File bin=new File("bin");
	static File cppBin = new File("bin/cpp");
	static File asmBin = new File("bin/asm");
	static File javaBin = new File("bin/java");
	...
	public static void compileCpp(File f) throws IOException {
