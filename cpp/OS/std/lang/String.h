...
/*
 * String.h
 * Incredibly useful in any language, I implemented my own version of the String datatype.
 * The main difference between C++'s string and this is that this one is immutable, which is nice,
 * and can be optimized in assembly later on for speed.
 *
